...
| - Footprint Modelling          | - Matlab                       | - ArcGIS Pro & QGIS     |
| - Flux Chamber Sampling        | - R                            | - Google Earth Engine   |
| - Drone Surveying              | - Javascript                   | - Mapbox API            |
| - Machine Learning             | - CRBasic                      | - Loggernet             |
| - Image Classification         | - HTML/CSS                     | - Eddy Pro              |
| - Process Based Modelling      | - Markdown                     | - Quarto                |
+--------------------------------+--------------------------------+-------------------------+
