...
+--------------------------------------------------------------------------------+----------------+
| Sessional Instructor: UBC Geography Department                                 | &npsp;         |
|                                                                                |                |
| - Atmospheric Environments: [Course Webpage](https://geos200.github.io/)       | 2023           |
| - Geographic Information Science: [Course Webpage](https://geos270.github.io/) | 2020 - 2023    |
+--------------------------------------------------------------------------------+----------------+
| Field Assistant: UBC Micrometeorology                                          |                |
+--------------------------------------------------------------------------------+----------------+
| Graduate Academic Assistant:                                                   | &npsp;         |
|                                                                                |                |
| - UBC Library Research Commons                                                 | 2020 - 2022    |
| - Vancouver Summer Program, UBC School of Community and Regional Planning      | 2019           |
+--------------------------------------------------------------------------------+----------------+
| Teaching Assistant:                                                            | &npsp;         |
|                                                                                |                |
| - UBC Geography Department                                                     | 2015 - 2019    |
