...
I've developed a python based tool for creating flux footprints web maps using the Kljun et al. (2015) flux footprint model.  The maps for our field sites are shown in the image below.
